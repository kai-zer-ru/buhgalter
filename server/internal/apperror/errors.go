...
func inferField(msgKey string) string {
	...
	case "ERR_GROUP_BY":
		return "group_by"
	case "ERR_ACCOUNT_NOT_FOUND", "ERR_ACCOUNT_ARCHIVED", "ERR_ACCOUNT_ARCHIVED_EDIT", "ERR_ACCOUNT_PRIMARY_ARCHIVED", "ERR_ACCOUNT_PRIMARY_CREDIT_CARD", "ERR_CREDIT_CARD_ARCHIVE_NOT_FULLY_PAID":
		return "account_id"
