...
func inferField(msgKey string) string {
	...
	case "ERR_GROUP_BY":
		return "group_by"
	case "ERR_ACCOUNT_NOT_FOUND", "ERR_ACCOUNT_ARCHIVED", "ERR_ACCOUNT_ARCHIVED_EDIT", "ERR_ACCOUNT_PRIMARY_ARCHIVED", "ERR_ACCOUNT_PRIMARY_CREDIT_CARD", "ERR_CREDIT_CARD_ARCHIVE_NOT_FULLY_PAID", "ERR_CREDIT_CARD_LIMIT_DECREASE_NOT_FULLY_PAID", "ERR_ACCOUNT_CREDIT_LIMIT_IMMUTABLE", "ERR_ACCOUNT_INVALID_CREDIT_LIMIT":
		return "account_id"
