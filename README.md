...
- **Android-клиент** — приложение к вашему инстансу: вход по логину/паролю или API-токену, офлайн-очередь, виджеты, share-intent, поиск сервера в LAN (mDNS), PIN и биометрия, **перехват push банков** → черновик операции. APK — в [GitHub Releases](https://github.com/kai-zer-ru/buhgalter/releases). Подробнее — [Android-клиент](#android-клиент) и [docs/android-client.md](docs/android-client.md).
...
- **Перехват push банков** (opt-in): черновики расхода/дохода из уведомлений → подтверждение в форме.
...
- Блокировка PIN + биометрия (кнопка отпечатка на клавиатуре PIN); при выходе, отключении сервера или истечении сессии блокировка сбрасывается.
...
Справочники по установке, данным, UI и API — [docs/README.md](docs/README.md). История изменений — [CHANGELOG.md](CHANGELOG.md). Release notes v1.5.0 — [docs/release-notes-v1.5.0.md](docs/release-notes-v1.5.0.md).
