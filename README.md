...
- **Счета и операции** — наличные, банковские и кредитные карты; архивация и мягкое удаление с переводом остатка; автопополнение банковского счёта по порогу. Категории с иконками, доходы, расходы и переводы (в том числе с комиссией). Плановые операции, повтор из меню строки, периодические списания.
