...
- **Кредиты** — потребительские и ипотека: график платежей, опциональный учёт суммы займа в балансе, правка будущих сумм, оплата вручную и автосписание по расписанию. Расход из формы (категория «Кредиты» → список кредитов) или **«Сделать платежом по кредиту»** из журнала привязывается к ближайшему платежу графика.
...
- **Перехват push и SMS банков и платёжных приложений** (opt-in): черновики расхода/дохода из уведомлений или SMS → подтверждение в форме; в шторке — **Принять** / **Отклонить**; из истории — снова создать операцию или перевод без ручного ввода суммы. Кошельки (MIR Pay, Samsung Pay, СБПэй и др.) — тот же пайплайн; из пары расход+пополнение можно оформить перевод. Один банк можно привязать к нескольким счетам.
