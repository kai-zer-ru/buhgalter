...
- Счета (наличные и банковские), категории с иконками, операции и переводы
- Долги и кредиты с графиками платежей
...
- Админка: пользователи, бэкапы, диагностика, секретный ключ шифрования токенов уведомлений
- REST API и интерактивная документация OpenAPI

Идеи после v1 — в [ROADMAP.md](ROADMAP.md).
