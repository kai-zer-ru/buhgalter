...
| Кредиты | Полный график по сроку; правка сумм неоплаченных платежей; ретро-платежи «списан со счёта» |
| Переводы | Поле комиссии → системная категория «Комиссия» |
| UI | Мобильное меню, карточки, touch-targets, bottom sheet модалок |
| Прочее | Демо-стенд, кнопка доната в админке |
