...
- Блокировка PIN + биометрия (кнопка отпечатка на клавиатуре PIN); при выходе, отключении сервера или истечении сессии блокировка сбрасывается. Параллельная копия приложения (dual-app) не затирает вход основной установки.
