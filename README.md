...
- Офлайн: очередь изменений (операции, переводы, категории, долги в т.ч. погашение, счета, бюджет, действия по кредитам без создания, периодические операции) с replay при появлении сети; кеш справочников и карточки кредита.
