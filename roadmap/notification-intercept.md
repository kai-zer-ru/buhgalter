...
| UI | Одна карточка «Возможный перевод» на уникальную пару (расход и доход не дублируются в списке); «Как две операции» разъединяет. Чекбоксы у остальных — перевод из выбора или удалить несколько |
