...
| Фильтр | Только **покупки/списания**; OTP, баланс, отказы, входящие/пополнения/выплаты процентов — игнор |
...
| Категория | При открытии черновика: если магазин из справочника — подставить самую частую пару категория/подкатегория из последних расходов этого merchant; иначе primary. Правила — [category-rules-inbox.md](category-rules-inbox.md) |
...
| Черновик | Prefill: сумма, дата, магазин, счёт, категория/подкатегория (эвристика по истории merchant); подтверждение или удаление |
...
flowchart LR
  ...
  Drafts -->|confirm| Form[Форма расхода]
