...
Реализовано в **v1.5.0** (push), **v1.5.1** (SMS), **v1.5.4** (платёжные приложения и перевод из черновиков), **v1.5.5** (одна карточка пары, счётчик, без зависания), **v1.6.0** (quick-actions в шторке) ([ROADMAP](../ROADMAP.md#v160)).
