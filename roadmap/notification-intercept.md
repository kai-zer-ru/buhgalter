...
Тот же пайплайн, что у банковского push. Кошельки **не** появляются в привязке «счёт → банк».
...
Перевод между своими банками даёт два push: списание в одном и пополнение в другом (одна сумма, близкое время). В очереди два черновика — расход и доход. Их можно оформить как **один перевод**, а не две операции.
