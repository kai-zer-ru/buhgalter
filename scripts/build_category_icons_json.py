...
ICONS: list[dict] = [
    ...
    {"id": "tram", "emoji": "🚊", "kind": "expense", "tags": ["трамвай", "транспорт"]},
    {"id": "trolleybus", "emoji": "🚎", "kind": "expense", "tags": ["троллейбус", "транспорт"]},
    {"id": "bike", "emoji": "🚲", "kind": "expense", "tags": ["велосипед", "транспорт"]},
    {"id": "motorcycle", "emoji": "🏍️", "kind": "expense", "tags": ["мотоцикл", "транспорт"]},
    {"id": "fuel", "emoji": "⛽", "kind": "expense", "tags": ["бензин", "топливо", "азс"]},
    {"id": "parking", "emoji": "🅿️", "kind": "expense", "tags": ["парковка", "стоянка"]},
    {"id": "car-wash", "emoji": "🚿", "kind": "expense", "tags": ["мойка", "авто"]},
    {"id": "fine", "emoji": "🚨", "kind": "expense", "tags": ["штраф", "гибдд"]},
    ...
    {"id": "tea", "emoji": "🍵", "kind": "expense", "tags": ["чай"]},
    {"id": "fastfood", "emoji": "🍔", "kind": "expense", "tags": ["фастфуд", "бургер", "еда"]},
    {"id": "pizza", "emoji": "🍕", "kind": "expense", "tags": ["пицца", "еда"]},
    {"id": "sushi", "emoji": "🍣", "kind": "expense", "tags": ["суши", "еда"]},
    {"id": "sweets", "emoji": "🍬", "kind": "expense", "tags": ["сладости", "конфеты"]},
    {"id": "grocery", "emoji": "🥬", "kind": "expense", "tags": ["овощи", "продукты"]},
    {"id": "fruit", "emoji": "🍎", "kind": "expense", "tags": ["фрукты"]},
    {"id": "meat", "emoji": "🥩", "kind": "expense", "tags": ["мясо"]},
    {"id": "dairy", "emoji": "🥛", "kind": "expense", "tags": ["молоко", "молочка"]},
    ...
    {"id": "psychologist", "emoji": "🧠", "kind": "expense", "tags": ["психолог", "терапия"]},
    ...
    {"id": "laundry", "emoji": "🧺", "kind": "expense", "tags": ["стирка", "химчистка"]},
    {"id": "hygiene", "emoji": "🧴", "kind": "expense", "tags": ["гигиена", "химия", "шампунь"]},
    {"id": "garden", "emoji": "🌱", "kind": "expense", "tags": ["сад", "растения", "дача"]},
    {"id": "lamp", "emoji": "💡", "kind": "expense", "tags": ["освещение", "лампа"]},
    {"id": "sauna", "emoji": "🧖", "kind": "expense", "tags": ["баня", "сауна"]},
    ...
    {"id": "manicure", "emoji": "💅", "kind": "expense", "tags": ["маникюр", "ногти"]},
    {"id": "massage", "emoji": "💆", "kind": "expense", "tags": ["массаж", "спа"]},
    {"id": "glasses", "emoji": "👓", "kind": "expense", "tags": ["очки", "оптика"]},
    {"id": "entertainment", "emoji": "🎬", "kind": "expense", "tags": ["развлечения", "кино"]},
    {"id": "movie", "emoji": "🍿", "kind": "expense", "tags": ["кино", "фильм"]},
    {"id": "theater", "emoji": "🎭", "kind": "expense", "tags": ["театр"]},
    {"id": "museum", "emoji": "🖼️", "kind": "expense", "tags": ["музей"]},
    ...
    {"id": "camping", "emoji": "⛺", "kind": "expense", "tags": ["кемпинг", "палатка"]},
    {"id": "fishing", "emoji": "🎣", "kind": "expense", "tags": ["рыбалка"]},
    ...
    {"id": "kindergarten", "emoji": "🎒", "kind": "expense", "tags": ["детский сад", "дети"]},
    ...
    {"id": "vet", "emoji": "🩺", "kind": "expense", "tags": ["ветеринар", "питомец"]},
    ...
    {"id": "post", "emoji": "📮", "kind": "expense", "tags": ["почта", "письмо"]},
    ...
    {"id": "scholarship", "emoji": "📜", "kind": "income", "tags": ["стипендия", "доход"]},
    {"id": "benefit", "emoji": "🪪", "kind": "income", "tags": ["пособие", "соцвыплата"]},
