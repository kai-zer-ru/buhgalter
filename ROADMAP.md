...
- [ ] На главной странице (десктоп) "Общий баланс" и "Долги" можно объединить в один блок (горизонтальный). Сейчас получается что много пустого места справа в каждом блоке. На мобилке оставить два блока
