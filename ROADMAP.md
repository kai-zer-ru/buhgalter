...
Подробности в [roadmap/](roadmap/).


- [x] [Сброс и восстановление пароля](roadmap/password-reset.md) — запрос на странице входа, уведомление админу, сброс в админке
- [x] [Адаптация под мобильные браузеры](roadmap/mobile-web.md) — responsive UI, карточки вместо широких таблиц, touch-targets
- [x] [Списание ретро-платежей](roadmap/credit-retroactive-debit.md) — при создании кредита: «списан со счёта» для хвоста уже учтённых платежей 
...
- [x] [Ипотека](roadmap/mortgage.md) — тип кредита: первоначальный взнос и расчёт процентов по фактическим дням; опция «не списывать с баланса»