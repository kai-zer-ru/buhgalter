...
- [ ] В шаблон сообщения о запросе сброса пароля (для мессенджеров) - добавить ссылку для прямого перехода на страницу. При отсутствии внешнего URL - указываем что нет внешней ссылки "настройте внешний URL в админке"
