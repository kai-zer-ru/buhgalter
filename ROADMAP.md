...
- [ ] Страница счёта, список операций (например яндекс). При клике в операции перевода на счёт, с которого был перевод в данный счёт - не переходит на страницу другого счёта. Но при клике на счёт, на который был перевод с текущего счёта - переходит на другой счёт верно
