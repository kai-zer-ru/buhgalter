...
- [ ] В окне перевода - при выборе счёта - удалять его из второго селекта. А то сейчас можно перевести с Яндекса на Яндекс (будет ошибка, правильно, но в UI это можно выставить) 
