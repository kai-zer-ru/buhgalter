...
- [ ] [Привязать операцию к оплате кредита](roadmap/credit-payment-link.md) — как у подписок: категория «Кредиты» в форме (вместо подкатегорий — список кредитов) + «Сделать платежом» из журнала; автобэкфилл категории у старых платежей графика
