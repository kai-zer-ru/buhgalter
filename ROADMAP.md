...
- [ ] В шаблон сообщения о запросе сброса пароля (для мессенджеров) - добавить ссылку для прямого перехода на страницу
...
- [ ] Навести порядок в SQL (что-то в коде, что-то вынесено в SQLC). И вынести это в правило.
