...
- [ ] При удалении счёта - счёт остаётся в базе в статусе "deleted", и доступен к просмотру. Удалять с предупреждением. В списке операций у такого счёта делать пометку, что он удалён. Добавить вкладку "Удалённые счета", где можно посмотреть данные счёта, историю и так далее. То же самое можно смотреть и у архивного счёта. У архивного счёта - тоже добавить пометку, что он архивный в списках операций
...
- [ ] В мобике меню слишком длинное получается, если раскрыть подменю, надо подумать. Надо наверное в мобилке при нажатии на меню - выводить его чуть нижже. В общем надо тестировать
- [x] В мобилке на главной счета скрыть под спойлер
- [ ] [Поддержание баланса](roadmap/maintaining-balance.md)
- [ ] переверстать /stats, блоки горизонтальными сделать
