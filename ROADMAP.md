...
- [ ] Окно "Редактировать операцию" - календпрь уходит за границы экрана вниз. Его надо открывать вверх, сейчас он открывается вниз
- [ ] /transactions - разделить плановые (скрыть под спойлер), и под ними отдельным блоком "Прошлые операции"
- [ ] В верхнее меню добавить "Операции"
- [ ] Автопополнение: ✓ заменить на Автопополнение: Яндекс (имя счёта, откуда пополняется)
