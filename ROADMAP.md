...
- [ ] Везде, где выводятся суммы - добавить форматирование. Все суммы (отображение) должны проходить через компонент форматирования (пробелы, точка, знак валюты). Сделать это универсальным компонентом и использовать везде. Записать в документацию
...
- [ ] В мобилке на главной счета скрыть под спойлер
