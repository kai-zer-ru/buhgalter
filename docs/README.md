...
История изменений по версиям — [CHANGELOG.md](../CHANGELOG.md). Последний релиз: [release-notes-v1.5.2.md](release-notes-v1.5.2.md).
...
| [release-notes-v1.5.2.md](release-notes-v1.5.2.md) | Release notes v1.5.2 |
