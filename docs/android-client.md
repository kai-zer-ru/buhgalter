...
**Перехват уведомлений:** opt-in чтение push и SMS банков и платёжных приложений (MIR Pay, Samsung Pay, СБПэй и др.) → черновик расхода или дохода. Уникальная пара расход+пополнение — одна карточка перевода. Настройки — **Банковские уведомления**. Подробнее — [android-client-platform.md](android-client-platform.md), [notification-intercept.md](../roadmap/notification-intercept.md).
