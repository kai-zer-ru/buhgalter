...
- Импорт: пресет **Бухгалтер** рядом с Cubux; экспорт CSV с выбором формата
...
- Нативный импорт/экспорт `preset=buhgalter` / `format=buhgalter` (колонки Cubux + время, магазин, теги)
